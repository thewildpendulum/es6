...
var _componentsClock = require('./components/clock');

var _componentsClock2 = _interopRequireDefault(_componentsClock);

_react2['default'].render(_react2['default'].createElement(_componentsClock2['default'], null), document.querySelector('.clock'));


},{"./components/clock":2,"react":159}],2:[function(require,module,exports){
'use strict';
...
function getAppState() {
    return {
        time: (0, _moment2['default'])().format('dddd, MMMM Do YYYY, h:mm:ss a')
    };
}
...
var Clock = _react2['default'].createClass({
    ...
    componentDidMount: function componentDidMount() {
        ...
        setInterval(function () {
            return _this.setState(getAppState());
        }, 1000);
    },
...
},{"moment":4,"react":159}],3:[function(require,module,exports){
